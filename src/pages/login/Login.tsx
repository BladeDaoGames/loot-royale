  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 pt-10 items-center absolute bottom-20 right-20 w-5/12 h-1/2 bg-white-beige-50 rounded-lg shadow-lg p-5 z-20">
        ...
        <Button onClick={handlePlayClick} className="w-4/12 h-4/12 shadow-lg rounded-lg">Play</Button>
        {/* Replace () => { } below with relevant function */}
        <Button onClick={() => { }} className="w-4/12 h-4/12 shadow-lg rounded-lg">How to Play</Button>
        <div className="flex justify-between items-center w-full mt-auto text-3xl">
          ...
          <div className="flex gap-6">
            <SocialLink icon={<FaTwitter />} label="Twitter" className="text-twitter-100" />
            <SocialLink icon={<BsDiscord />} label="Discord" className="text-discord-100 pr-4" />
          </div>
        </div>
      </div>
    </>
